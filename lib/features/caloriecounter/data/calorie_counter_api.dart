...
class CalorieCounterApi {
  ...
  static Future<Map<String, dynamic>> calculateCalories({
    ...
    return ApiClient.post(
      '/foods/calculate',
      body: {'FoodName': foodName.trim(), 'FoodQuantity': foodQuantity},
    );
  }
  ...
  static Future<Map<String, dynamic>> getAllFoodByUser({required int userId}) {
  ...
  static Future<Map<String, dynamic>> deleteFood({required int foodId}) {
